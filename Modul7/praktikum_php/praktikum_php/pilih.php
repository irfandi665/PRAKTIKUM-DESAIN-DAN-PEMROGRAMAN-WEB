...
<body>
	...
	<form action="hasil.php" method="post">
		...
		<td><input type="radio" name="tim">Mystic Force</td>
		<td><input type="radio" name="tim">Dino</td>
		<td><input type="radio" name="tim">SPD</td>
		</td></tr>
		...
		<tr><td></td><td colspan = "3"><input class="daftar" type="button"onclick="document.location='hasil.php'" name="submit"value="Submit"></td></tr>
	</form>
