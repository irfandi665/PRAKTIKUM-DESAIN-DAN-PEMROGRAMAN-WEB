...
<div class="row">
    ...
    <div class="rightcolumn">
        <div class="card">
        <h2>About Me</h2>
        <div class="fakeimg" align="center" style="height:100px;"><img src="asset/img/logo.png" Width="70" alt=""></div>
        ...
        <?php $ambil=$koneksi ->
        query("select * from tb_berita order by id"); ?>

        <?php while ($row=$ambil->fetch_assoc()) {?>
            <div class="fakeimg"><a href="#" style="text-decoration:none"><?php echo $row ["judul"];?></a></div>
        <?php } ?>
